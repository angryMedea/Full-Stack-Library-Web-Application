    ...
    return (
        <div className={props.mobile ? 'mt-3' : 'row mt-5'}>
            ...
            <div className='col-sm-10 col-md-10'>
                ...
                // use React Fragment grammar <></> to combine multiple elements without more DOM element
                    <>  
                        {/* slice() means getting the first three elements from the reviews array */}
                        {props.reviews.slice(0, 3).map(eachReview => (
                            // for every reviews element, create a Review component
